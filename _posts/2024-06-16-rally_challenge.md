...
- *Whiteness*, which is a measure of how smooth the steering commands are, measured commonly in degree units per second. Lower values usually indicate smoother steering.
